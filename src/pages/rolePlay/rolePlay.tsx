...
const RolePlay = () => {
    ...
    if (step === STEPS.GRADING) {
        ...
        bubbleClass += gradingResult === 'CORRECT' ? ' correct' : gradingResult === 'INCORRECT' ? ' incorrect' : ' oos';
    } else {
    ...
    return (
        ...
        <div className="page-container app-container">
            ...
            <div className={`role-content-window rolePlay-content-window ${step === STEPS.START ? 'slide-out' : ''}`}>
                
                <div className="card-title-bar"> {/* 카드 타이틀/스텝 바 */}
                ...
                <div className="text-display-box">
                    ...
                    <div className="text-line korean-line">
                        ...
                        <button className={`tts-button${getTtsButtonClass()}`}>
                            🔊
                        </button>
                    </div>
                    ...
                    <div className="text-line romanized-line">
                        ...
                        <span className={`small-mic-icon${getSmallMicClass()}`}>
                            🎤
                        </span>
                    </div>
